...
class WirtualController extends StatefulWidget {
  final double baseSize;
  final double stickSize;
  final void Function(Offset) onStickMove;

  const WirtualController(
      {Key key,
  ...
  State<StatefulWidget> createState() {
    ...
    return _WirtualControllerState(
      baseSize2,
      stickSize,
      onStickMove,
    );
...
class _WirtualControllerState extends State<WirtualController> {
  final double baseSize;
  final double stickSize;
  var tapCount = 0;
  ...
  _WirtualControllerState(this.baseSize, this.stickSize, this.onStickMove) {
    radius = baseSize / 2;
